...
def frechet(frames1,frames2):
    true_mu,true_sigma = calculate_activation_statistics(frames1,InceptionV3(),frames1.shape[0])
    pred_mu,pred_sigma = calculate_activation_statistics(frames2,InceptionV3(),frames2.shape[0])
    return calculate_frechet_distance(true_mu, true_sigma, pred_mu, pred_sigma)
